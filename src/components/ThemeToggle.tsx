...
export default function ThemeToggle() {
  // Adicionando try/catch para evitar o erro quando o contexto não estiver disponível
  try {
    ...
    // Fallback quando o contexto não estiver disponível
    return (
      <button className="relative p-2 rounded-full w-12 h-6 flex items-center bg-neutral-700">
